...
# ToF settings
# CH0 and CH1 are ToF sensors. CH2 is reserved for MPU6050 on the Teensy.
TOF_NUM_CHANNELS = 2
TOF_CHANNELS_DEFAULT = 2
TOF_CHANNELS_MAX = 2
TOF_DEFAULT_PORT = "/dev/ttyACM1"
TOF_BAUD_RATE = 115200
TOF_THRESHOLD_MM = 300.0
TOF_FRESHNESS_S = 0.4
OBSTACLE_DECAY_S_DEFAULT = 3.0
TOF_UPSAMPLE_N = 40
TOF_SURFACE_EVERY = 5
...
KEY_BINDINGS = {
    ...
    ord("h"): "go_home",
    ord("H"): "set_equil",
    ord("m"): "states_menu", ord("M"): "states_menu",
    ord("x"): "seq_editor", ord("X"): "seq_editor",

    # Optional plotting controls (plots disabled by default at startup)
    ...
    ord("t"): "tuning_menu", ord("T"): "tuning_menu",
...
# Future planning preview (for optimizer trajectory visualization)
