...
#define IMU_LOGICAL_CH 2  // logical channel id; MPU is on direct I2C bus
#define IMU_SEND_INTERVAL_MS 10

SparkFun_VL53L5CX imager[NUM_TOF_SENSORS];
VL53L5CX_ResultsData results[NUM_TOF_SENSORS];
bool tofPresent[NUM_TOF_SENSORS] = {false, false};

const uint8_t TOF_MUX_CH[NUM_TOF_SENSORS] = {0, 1};
...
uint8_t activeChannelCount = NUM_TOF_SENSORS;  // Host can override via ACT <n>
uint8_t rrCursor = 0;
...
static inline void printHelp() {
  Serial.println("Commands: CH0 | CH1 | MUX | ACT <1..2> | HELP");
}
...
bool initIMU() {
  ...
  // Use default accel (+/-2g) and gyro (+/-250 dps) ranges.
