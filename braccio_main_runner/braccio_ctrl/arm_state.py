...
class ArmState:
    def __init__(self):
        ...
        self.control_mode: str = "nominal_follow"
        ...
        self.obstacle_decay_s: float = 5.0
        self.obstacle_class: str = "SWEEP"
        self.tof_channels_enabled: int = 0
        self.hyperion_mode: bool = False
    ...
    def snapshot(self) -> dict:
        with self._lock:
            return {
                ...
                "hyperion_mode": self.hyperion_mode,
