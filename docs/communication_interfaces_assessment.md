...
- Main packets:
  - `TF,<...>` for ToF CH0/CH1 in standard mode, CH0..CH3 in Hyperion mode
  - `IMU,<...>` for MPU6050 on direct I2C
...
- Sensor rates in current firmware:
  - Legacy ToF round-robin across CH0/CH1 at ~15 Hz per channel (target)
  - Hyperion ToF round-robin across CH0..CH3 at 4x4 resolution with 60 Hz sensor-side ranging target
